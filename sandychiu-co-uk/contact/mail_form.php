...
$yourEmail = "orario002@hotmail.com"; // the email address you wish to receive these mails through
$yourWebsite = "Solo Me World"; // the name of your website
$thanksPage = '../contact-thank-you.html'; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
